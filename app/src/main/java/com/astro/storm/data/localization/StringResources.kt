...
enum class StringKeyDosha(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    ASHTOTTARI_ABOUT_DESC("Ashtottari Dasha is a conditional (Rashi-specific) planetary period system spanning 108 years. It is applicable when specific conditions are met based on the birth chart. Unlike Vimshottari, it excludes Sun and Ketu, using only 8 planets. The system is particularly effective for daytime births with Moon in Krishna Paksha or nighttime births with Moon in Shukla Paksha.", "अष्टोत्तरी दशा १०८ वर्षको सशर्त ग्रह अवधि प्रणाली हो। यो विशेष परिस्थितिहरूमा लागू हुन्छ। विंशोत्तरीको विपरीत, यसमा सूर्य र केतु छैन, केवल ८ ग्रह प्रयोग गरिन्छ। यो प्रणाली विशेष गरी कृष्ण पक्षमा चन्द्रमासहित दिनको जन्म वा शुक्ल पक्षमा चन्द्रमासहित रातको जन्मको लागि प्रभावकारी छ।"),
    ASHTOTTARI_APPLICABILITY("Applicability Check", "लागू हुने जाँच"),
    ASHTOTTARI_APPLICABLE("Ashtottari Dasha is applicable for this chart", "यो कुण्डलीको लागि अष्टोत्तरी दशा लागू हुन्छ"),
    ASHTOTTARI_NOT_APPLICABLE("Ashtottari Dasha may not be optimal for this chart", "यो कुण्डलीको लागि अष्टोत्तरी दशा उत्तम नहुन सक्छ"),
    ASHTOTTARI_CONDITION_MET("Condition Met", "सर्त पूरा भयो"),
    ASHTOTTARI_CONDITION_NOT_MET("Condition Not Met", "सर्त पूरा भएन"),
    ASHTOTTARI_MOON_PAKSHA("Moon's Paksha at Birth", "जन्ममा चन्द्रमाको पक्ष"),
    ASHTOTTARI_BIRTH_TIME("Birth Time (Day/Night)", "जन्म समय (दिन/रात)"),
    ASHTOTTARI_KRISHNA_PAKSHA("Krishna Paksha (Waning)", "कृष्ण पक्ष (घट्दो)"),
    ASHTOTTARI_SHUKLA_PAKSHA("Shukla Paksha (Waxing)", "शुक्ल पक्ष (बढ्दो)"),
    ASHTOTTARI_DAY_BIRTH("Day Birth", "दिनको जन्म"),
    ASHTOTTARI_NIGHT_BIRTH("Night Birth", "रातको जन्म"),
    ...
    ASHTOTTARI_COMPARISON("Vimshottari vs Ashtottari", "विंशोत्तरी बनाम अष्टोत्तरी"),
    ...
    SUDARSHANA_ABOUT_DESC("Sudarshana Chakra Dasha is a comprehensive timing system that simultaneously considers the Lagna (Ascendant), Chandra (Moon), and Surya (Sun) charts. Each year progresses through signs from these three reference points, giving a holistic view of life events. This system is particularly useful for understanding the multi-dimensional nature of time periods.", "सुदर्शन चक्र दशा एक व्यापक समय प्रणाली हो जसले लग्न, चन्द्र र सूर्य कुण्डली एकैसाथ विचार गर्दछ। प्रत्येक वर्ष यी तीन सन्दर्भ बिन्दुहरूबाट राशिहरू मार्फत अगाडि बढ्छ, जीवन घटनाहरूको समग्र दृष्टिकोण दिन्छ।"),
    ...
    SUDARSHANA_CURRENT_SIGNS("Current Signs Active", "वर्तमान सक्रिय राशिहरू"),
    SUDARSHANA_AGE("Age", "उमेर"),
    SUDARSHANA_YEAR("Year", "वर्ष"),
    SUDARSHANA_TRIPLE_VIEW("Triple Reference View", "त्रि-सन्दर्भ दृश्य"),
    SUDARSHANA_COMBINED_ANALYSIS("Combined Period Analysis", "संयुक्त अवधि विश्लेषण"),
    SUDARSHANA_LAGNA_INFLUENCE("Lagna Influence: Physical body, self, and initiative", "लग्न प्रभाव: शारीरिक शरीर, आत्म, र पहलकदमी"),
    SUDARSHANA_CHANDRA_INFLUENCE("Chandra Influence: Mind, emotions, and public image", "चन्द्र प्रभाव: मन, भावनाहरू, र सार्वजनिक छवि"),
    SUDARSHANA_SURYA_INFLUENCE("Surya Influence: Soul, authority, and recognition", "सूर्य प्रभाव: आत्मा, अधिकार, र मान्यता"),
    SUDARSHANA_YEAR_ANALYSIS("Year %d Analysis", "वर्ष %d विश्लेषण"),
    SUDARSHANA_SIGN_LORD("Sign Lord", "राशि स्वामी"),
    SUDARSHANA_HOUSE_SIGNIFICATIONS("House Significations", "भाव करकत्व"),
    ...
    SUDARSHANA_WEAK_CONVERGENCE("Mixed Influences", "मिश्रित प्रभावहरू"),

    // ============================================
    // MRITYU BHAGA SCREEN
    // ============================================
    MRITYU_BHAGA_TITLE("Mrityu Bhaga Analysis", "मृत्यु भाग विश्लेषण"),
    MRITYU_BHAGA_SUBTITLE("Sensitive Degrees in Chart", "कुण्डलीमा संवेदनशील अंशहरू"),
    MRITYU_BHAGA_ABOUT("About Mrityu Bhaga", "मृत्यु भागको बारेमा"),
    MRITYU_BHAGA_ABOUT_DESC("Mrityu Bhaga (Death Portion) refers to specific sensitive degrees in each zodiac sign. When planets occupy these degrees, they can indicate areas of life requiring extra attention. These are not predictions of death but rather sensitive points that may indicate health vulnerabilities, accidents, or significant life challenges when activated.", "मृत्यु भागले प्रत्येक राशिमा विशेष संवेदनशील अंशहरूलाई जनाउँछ। जब ग्रहहरू यी अंशहरूमा हुन्छन्, तिनीहरूले थप ध्यान चाहिने जीवनका क्षेत्रहरू संकेत गर्न सक्छन्। यो मृत्युको भविष्यवाणी होइन तर संवेदनशील बिन्दुहरू हुन् जसले स्वास्थ्य कमजोरी, दुर्घटना, वा महत्त्वपूर्ण जीवन चुनौतीहरू संकेत गर्न सक्छन्।"),
    ...
    MRITYU_BHAGA_EXACT("Exact (Critical)", "सटीक (गम्भीर)"),
    MRITYU_BHAGA_CLOSE("Close (Caution)", "नजिक (सावधान)"),
    MRITYU_BHAGA_APPROACHING("Approaching", "नजिकिँदै"),
    MRITYU_BHAGA_LIFE_AREAS("Affected Life Areas", "प्रभावित जीवन क्षेत्रहरू"),
    MRITYU_BHAGA_REMEDIES("Suggested Remedies", "सुझाव गरिएका उपायहरू"),
    MRITYU_BHAGA_TRANSIT_WARNING("Transit Alerts", "गोचर चेतावनीहरू"),
    MRITYU_BHAGA_TRANSITING_PLANETS("Planets transiting Mrityu Bhaga", "मृत्यु भागबाट गोचर गर्दै गरेका ग्रहहरू"),
    ...
    MRITYU_BHAGA_INTERPRETATION("Interpretation", "व्याख्या"),
    ...
    LAL_KITAB_SCREEN_ABOUT_DESC("Lal Kitab is a unique system of Vedic palmistry and remedial astrology from Punjab. It offers simple, practical remedies using everyday items like turmeric, milk, honey, and specific actions. These remedies work on karmic debts (Rin) and planetary afflictions without expensive rituals.", "लाल किताब पंजाबको अद्वितीय वैदिक हस्तरेखा र उपचार ज्योतिष प्रणाली हो। यसले बेसार, दूध, मह जस्ता दैनिक वस्तुहरू प्रयोग गरी सरल, व्यावहारिक उपायहरू प्रदान गर्दछ। यी उपायहरूले महँगो विधि बिना कार्मिक ऋण र ग्रह पीडामा काम गर्दछन्।"),
    LAL_KITAB_KARMIC_DEBTS("Karmic Debts (Rin)", "कार्मिक ऋणहरू"),
    LAL_KITAB_PLANETARY_AFFLICTIONS("Planetary Afflictions", "ग्रह पीडाहरू"),
    ...
    LAL_KITAB_REMEDY_DURATION_PERIOD("Recommended Duration", "सिफारिस गरिएको अवधि"),
    ...
    LAL_KITAB_EFFECTIVENESS_SUPPORTIVE("Supportive", "सहायक"),
    ...
    DIVISIONAL_CHARTS_ABOUT_DESC("Divisional charts (Vargas) provide deeper insights into specific life areas. Each Varga zooms into particular aspects: D-2 for wealth, D-3 for siblings, D-9 for marriage, D-10 for career, D-12 for parents. Analysis of these charts with the main Rashi chart gives comprehensive life understanding.", "विभागीय कुण्डलीहरू (वर्ग) ले विशेष जीवन क्षेत्रहरूमा गहिरो अन्तर्दृष्टि प्रदान गर्दछन्। प्रत्येक वर्गले विशेष पक्षहरूमा जुम गर्दछ: D-2 धनको लागि, D-3 भाइबहिनीको लागि, D-9 विवाहको लागि, D-10 क्यारियरको लागि, D-12 अभिभावकको लागि।"),
    ...
    DIVISIONAL_HOUSE_LORD("House Lord", "भाव स्वामी"),
    ...
    // ============================================
    UPACHAYA_TRANSIT_TITLE("Upachaya Transits", "उपचय गोचर"),
    UPACHAYA_TRANSIT_SUBTITLE("Growth House Transit Tracker", "वृद्धि भाव गोचर ट्र्याकर"),
    UPACHAYA_TRANSIT_ABOUT("About Upachaya Houses", "उपचय भावहरूको बारेमा"),
    UPACHAYA_TRANSIT_ABOUT_DESC("Upachaya houses (3, 6, 10, 11) are growth houses where malefic planets give good results over time. Natural malefics like Saturn, Mars, Rahu in these houses improve with age. Tracking transits through Upachaya from Moon shows periods of growth and improvement.", "उपचय भावहरू (३, ६, १०, ११) वृद्धि भावहरू हुन् जहाँ पापग्रहले समयसँगै राम्रो परिणाम दिन्छन्। शनि, मंगल, राहु जस्ता प्राकृतिक पापग्रह यी भावहरूमा उमेरसँगै सुधार हुन्छ। चन्द्रबाट उपचय मार्फत गोचर ट्र्याक गर्नाले वृद्धि र सुधारको अवधि देखाउँछ।"),
    UPACHAYA_HOUSES("Upachaya Houses (3, 6, 10, 11)", "उपचय भावहरू (३, ६, १०, ११)"),
    UPACHAYA_FROM_MOON("Transit from Moon Sign", "चन्द्र राशिबाट गोचर"),
    UPACHAYA_CURRENT_TRANSITS("Current Beneficial Transits", "वर्तमान लाभदायक गोचर"),
    UPACHAYA_UPCOMING("Upcoming Favorable Periods", "आगामी अनुकूल अवधिहरू"),
    ...
    UPACHAYA_HOUSE_3("3rd House - Courage, Siblings, Communication", "तेस्रो भाव - साहस, भाइबहिनी, सञ्चार"),
    UPACHAYA_HOUSE_6("6th House - Enemies, Service, Health", "छैटौं भाव - शत्रु, सेवा, स्वास्थ्य"),
    UPACHAYA_HOUSE_10("10th House - Career, Status, Authority", "दसौं भाव - क्यारियर, स्थिति, अधिकार"),
    UPACHAYA_HOUSE_11("11th House - Gains, Desires, Friends", "एघारौं भाव - लाभ, इच्छा, मित्र"),
    ...
    UPACHAYA_DURATION("Transit Duration", "गोचर अवधि"),
    UPACHAYA_EFFECTS("Expected Effects", "अपेक्षित प्रभावहरू"),
